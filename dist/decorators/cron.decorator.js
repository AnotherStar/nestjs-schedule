 ...
 */
function Cron(cronTime, options, context) {
    const name = options?.name;
    return (0, common_1.applyDecorators)((0, common_1.SetMetadata)(schedule_constants_1.SCHEDULE_CRON_OPTIONS, {
        ...options,
        cronTime,
    }), (0, common_1.SetMetadata)(schedule_constants_1.SCHEDULE_CRON_CONTEXT, context), (0, common_1.SetMetadata)(schedule_constants_1.SCHEDULER_NAME, name), (0, common_1.SetMetadata)(schedule_constants_1.SCHEDULER_TYPE, scheduler_type_enum_1.SchedulerType.CRON));
}
